...
EXPOSURE_TIME_KEY = os.getenv('EXPOSURE_TIME_KEY', 'EXPOSURE')
...
TARGET_NAME_KEY = os.getenv('TARGET_NAME_KEY', 'TRGNAME')
REQUEST_ID_KEY = os.getenv('REQUEST_ID_KEY', 'REQNUM')
REQUESTGROUP_ID_KEY = os.getenv('REQUESTGROUP_ID_KEY', 'TRACKNUM')
CONFIGURATION_TYPE_KEY = os.getenv('CONFIGURATION_TYPE_KEY', 'CONFTYPE')
...
RA_KEY = os.getenv('RA_KEY', 'TRGALPH')
DEC_KEY = os.getenv('DEC_KEY', 'TRGDELT')
