...
EXPOSURE_TIME_KEY = os.getenv('EXPOSURE_TIME_KEY', 'OBS TIME')
INSTRUMENT_ID_KEY = os.getenv('INSTRUMENT_ID_KEY', 'INSTRUME')
SITE_ID_KEY = os.getenv('SITE_ID_KEY', 'ORIGIN')
TELESCOPE_ID_KEY = os.getenv('TELESCOPE_ID_KEY', 'TELESCOP')
OBSERVATION_ID_KEY = os.getenv('OBSERVATION_ID_KEY', 'BLKUID')
CONFIGURATION_ID_KEY = os.getenv('CONFIGURATION_ID_KEY', 'MOLUID')
PRIMARY_OPTICAL_ELEMENT_KEY = os.getenv('PRIMARY_OPTICAL_ELEMENT_KEY', 'FILTER1')
TARGET_NAME_KEY = os.getenv('TARGET_NAME_KEY', 'TRG NAME')
REQUEST_ID_KEY = os.getenv('REQUEST_ID_KEY', 'REQNUM')
REQUESTGROUP_ID_KEY = os.getenv('REQUESTGROUP_ID_KEY', 'TRACKNUM')
CONFIGURATION_TYPE_KEY = os.getenv('CONFIGURATION_TYPE_KEY', 'OBS TYPE')
...
RA_KEY = os.getenv('RA_KEY', 'TRG ALPH')
DEC_KEY = os.getenv('DEC_KEY', 'TRG DELT')
